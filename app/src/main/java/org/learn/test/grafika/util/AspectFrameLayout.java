...
public class AspectFrameLayout extends FrameLayout {
    private static final String TAG = GrafikaMainActivity.TAG + "-AFL";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Target aspect ratio will be < 0 if it hasn't been set yet.
        // In that case, we just use whatever we've been handed.
        if (mTargetAspect > 0) {
